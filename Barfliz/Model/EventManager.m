...
////        EKCalendarType currentCalendarType = currentCalendar.type;
//        if (currentCalendar.type == EKCalendarTypeLocal || currentCalendar.type == EKCalendarTypeExchange || currentCalendar.type == EKCalendarTypeBirthday || currentCalendar.type == EKCalendarTypeCalDAV || currentCalendar.type == EKCalendarTypeSubscription) {
...
-(NSArray *)getEventsOfSelectedCalendar{
    ...
    for (int i=0; i<eventsArray.count; i++) {
        ...
        EKCalendar *calendar = currentEvent.calendar;
//        EKCalendarType currentCalendarType = calendar.type;
